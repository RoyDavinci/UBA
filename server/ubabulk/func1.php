...
function sendSMS($id, $address, $message)
{
    ...
    $urlWithQuery = "http://10.186.0.2:14033/cgi-bin/sendsms?alt-dcs=0&username=ubatest0&password=ubafoob0&to=$phone&dlr-mask=31&from=$sender&smsc=$smsc&dlr-url=$dlrURL2&req_dlr=1&dlr_type=1&text=" . urlencode("$message");
